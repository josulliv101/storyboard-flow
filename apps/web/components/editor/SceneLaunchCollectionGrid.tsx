...
type SceneLaunchCollectionGridProps = {
  collectionId: string;
...
export function SceneLaunchCollectionGrid({
  collectionId,
...
}: SceneLaunchCollectionGridProps) {
  return (
    <div
      className="rounded-lg border border-zinc-900 bg-zinc-950/30 p-3"
      onDragOver={(event) => event.preventDefault()}
      onDrop={(event) => handleBeatDrop(event, collectionId)}
    >
