...
.pb .strip .shot .s-in,
.pb .c-h.l{ left:0; border-radius:6px 0 0 6px; }
.pb .strip .shot .s-out,
.pb .c-h.r{ right:0; border-radius:0 6px 6px 0; }

/* The grip: 2px, rounded, black at 45% — full height and darker once armed. */
.pb .strip .shot .s-edge::after,
.pb .c-h::after{
...
.pb .strip .shot.trimming{ z-index:8; }
.pb .strip .shot .s-read{
...
/* THE LINE STOPS AT THE FILM, rather than running down through it.
   ...
   not. ─────────────────────────────────────────────────────────────────── */
.pb .ph-line{ top:32px; bottom:var(--strip-h, 150px); }
