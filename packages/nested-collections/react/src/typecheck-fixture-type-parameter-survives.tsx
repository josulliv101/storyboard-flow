...
// `ui.useFold("seconds", id)` returned `Folded<unknown>` with the core and
// the React half both compiling perfectly clean. The fix was a direct `Folds: F`
// occurrence on the core's `PhantomTypes`. This file is what would have caught
 ...
 * `unknown` before inference ever sees it. the core's own engine test hoists it
 * the same way.
 */
