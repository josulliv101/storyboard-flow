// Graph React — the shapes `createReactBindings` hands back.
//
...
//
// Every member below is METHOD SHORTHAND, matching the core's `ConsumerDefinedNodeType` and
 ...
 * and inventing a visual for it is a product decision the core cannot make.
 */
 ...
 */
export type HistoryControls<Ts extends readonly WidenedNodeType[], S> = Readonly<{
  canUndo: boolean;
  canRedo: boolean;
...
export type DispatchFn<Ts extends readonly WidenedNodeType[], S> = (
