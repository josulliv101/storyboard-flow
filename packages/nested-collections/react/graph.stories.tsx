 ...
 * what it looks like is a product decision the core cannot make for you.
 */
...
// ===========================================================================
//
// Graph SHIPS NO DRAG-AND-DROP, ON PURPOSE. It has no sensors, no collision
...
//
// That is the lesson: this story is not showing a Graph feature, it is showing
...
function DragBoard({ children }: Readonly<{ children: ReactNode }>) {
  ...
  const finish = useCallback(
    (event: React.PointerEvent<HTMLElement>) => {
      ...
      // ---- THE FOUR LINES THAT ARE ACTUALLY ABOUT GRAPH-CORE ------------------
