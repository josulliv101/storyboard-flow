// KEEL — what a 100,000-node graph costs with a REALISTIC viewport mounted.
//
// WHY THIS SHAPE. Every scaling number this package has was measured on
// keel-core in node, with no React and no DOM. The open question was never "can
...
const engine = createEngine<Types, Summary, typeof folds>({
  ...
  // failure has its own coverage in keel-core. Stated so the numbers are not
