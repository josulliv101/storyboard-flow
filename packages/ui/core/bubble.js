...
function BubbleGroup(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("div", Object.assign({ "data-slot": "bubble-group", className: cn("flex min-w-0 flex-col gap-2", className) }, props)));
}
...
function Bubble(_a) {
    var { variant = "default", align = "start", className } = _a, props = __rest(_a, ["variant", "align", "className"]);
    return (_jsx("div", Object.assign({ "data-slot": "bubble", "data-variant": variant, "data-align": align, className: cn(bubbleVariants({ variant }), className) }, props)));
}
function BubbleContent(_a) {
...
function BubbleReactions(_a) {
    var { side = "bottom", align = "end", className } = _a, props = __rest(_a, ["side", "align", "className"]);
    return (_jsx("div", Object.assign({ "data-slot": "bubble-reactions", "data-align": align, "data-side": side, className: cn(bubbleReactionsVariants({ side, align }), className) }, props)));
}
