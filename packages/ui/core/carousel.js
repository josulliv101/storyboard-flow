...
function CarouselPrevious(_a) {
    ...
    return (_jsxs(Button, Object.assign({ "data-slot": "carousel-previous", variant: variant, size: size, className: cn("absolute touch-manipulation rounded-full", orientation === "horizontal"
...
function CarouselNext(_a) {
    ...
    return (_jsxs(Button, Object.assign({ "data-slot": "carousel-next", variant: variant, size: size, className: cn("absolute touch-manipulation rounded-full", orientation === "horizontal"
