...
function Drawer(_a) {
    var { modal = true, showSwipeHandle = false, snapPoints, swipeDirection = "down" } = _a, props = __rest(_a, ["modal", "showSwipeHandle", "snapPoints", "swipeDirection"]);
    ...
    return (_jsx(DrawerContext.Provider, { value: contextValue, children: _jsx(DrawerPrimitive.Root, Object.assign({ "data-slot": "drawer", modal: modal, snapPoints: snapPoints, swipeDirection: swipeDirection }, props)) }));
}
...
function DrawerContent(_a) {
    ...
    return (_jsxs(DrawerPortal, { "data-slot": "drawer-portal", children: [modal === true && (_jsx(DrawerOverlay, { "data-snap-points": hasSnapPoints ? "" : undefined })), _jsx(DrawerPrimitive.Viewport, { "data-slot": "drawer-viewport", "data-modal": modal, className: "pointer-events-none fixed inset-0 z-50 select-none data-[modal=true]:pointer-events-auto", children: _jsxs(DrawerPrimitive.Popup, Object.assign({ "data-slot": "drawer-popup", "data-swipe-axis": swipeAxis, "data-snap-points": hasSnapPoints ? "" : undefined, className: cn(
                    // Base.
...
function DrawerHeader(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("div", Object.assign({ "data-slot": "drawer-header", className: cn("flex shrink-0 flex-col gap-0.5 p-4 pb-0 group-data-[swipe-axis=y]/drawer-popup:text-center md:gap-0.5 md:text-left", className) }, props)));
}
function DrawerFooter(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("div", Object.assign({ "data-slot": "drawer-footer", className: cn("mt-auto flex shrink-0 flex-col gap-2 p-4 pt-0", className) }, props)));
}
function DrawerTitle(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(DrawerPrimitive.Title, Object.assign({ "data-slot": "drawer-title", className: cn("text-base font-medium text-foreground", className) }, props)));
}
function DrawerDescription(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(DrawerPrimitive.Description, Object.assign({ "data-slot": "drawer-description", className: cn("text-sm text-balance text-muted-foreground", className) }, props)));
}
