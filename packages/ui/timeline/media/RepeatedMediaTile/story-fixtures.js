export function createStoryMediaDataUri(label, hue) {
    const svg = [
...
export const storyVideoSrc = "https://res.cloudinary.com/demo/video/upload/dog.mp4";
...
export const emptyCollectionClip = Object.assign(Object.assign({}, collectionClip), { id: "collection-empty", title: "Empty Collection", itemCount: 0, previewItems: [] });
