...
const meta = {
    ...
    decorators: [
        (Story) => (_jsx(PreviewWheelSettingsContext.Provider, { value: {
            ...
            }, children: _jsx("div", { className: "relative h-64 w-[500px] bg-zinc-950 border border-zinc-800 rounded flex items-center justify-center overflow-hidden", children: _jsx(Story, {}) }) })),
    ],
};
export default meta;
