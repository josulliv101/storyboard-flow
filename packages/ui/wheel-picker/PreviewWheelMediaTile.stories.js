...
import { PreviewWheelSettingsContext } from './SceneLaunchPreviewWheelV3';
...
const meta = {
    ...
    decorators: [
        (Story) => (_jsx(PreviewWheelSettingsContext.Provider, { value: {
                sizing: 'uniform',
                effect: 'cylinder',
                thumbnailSize: 'md',
                disabledItemIds: [],
            ...
            }, children: _jsx("div", { className: "relative h-64 w-[500px] bg-zinc-950 border border-zinc-800 rounded flex items-center justify-center", children: _jsx(Story, {}) }) })),
    ],
};
export default meta;
export const StandardImageTile = {
    args: {
        item: mockMedia,
        index: 0,
...
export const ActiveVideoTileWithProgress = {
    args: Object.assign(Object.assign({}, StandardImageTile.args), { item: Object.assign(Object.assign({}, mockMedia), { type: 'video', durationSeconds: 10 }), isActive: true, itemProgress: 0.45, isItemProgressPlaying: true, progressTimelineTime: 4.5 }),
};
export const ConcentricCircleFolderTile = {
    args: Object.assign(Object.assign({}, StandardImageTile.args), { item: mockCollectionMedia, isCollection: true }),
};
