...
//
// The entire point of splitting graph into two packages is that
...
// `ui.useFold("seconds", id)` returned `Folded<unknown>` with graph-core and
// graph-react both compiling perfectly clean. The fix was a direct `Folds: F`
// occurrence on graph-core's `PhantomTypes`. This file is what would have caught
 ...
 * `unknown` before inference ever sees it. graph-core's own engine test hoists it
 * the same way.
 */
