...
// `../../packages/graph-core/**/*.test.ts` but not graph-react; one more glob,
// `../../packages/graph-react/**/*.test.tsx`, runs this. The project is node-env
