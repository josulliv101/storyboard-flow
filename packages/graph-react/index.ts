...
// Graph React — the public surface.
//
// CURATED, not `export *`, for the same reason graph-core's barrel is: an
...
//
// `"use client"` sits on this module and on ./src/bindings.tsx. graph-core
